...
const translations: Translations = {
    ...
    q_dynamic_intro: { English: 'Great! To tailor your path, I have 3 subject-specific questions for you.', Spanish: '¡Genial! Para adaptar tu camino, tengo 3 preguntas específicas del tema.', French: 'Super ! Voici 3 questions spécifiques.', German: 'Super! Ich habe 3 fachspezifische Fragen für dich.', Hindi: 'बहुत अच्छा! आपके लिए मेरे पास 3 विषय-विशिष्ट प्रश्न हैं।', Chinese: '太棒了！为了量身定制，我有3个针对具体学科的问题।', Nepali: 'अति उत्तम! तपाईंको यात्रालाई अझ राम्रो बनाउन, मसँग ३ वटा विषय-विशिष्ट प्रश्नहरू छन्।' },
    q_dynamic_thinking: { English: 'Generating subject-specific questions...', Spanish: 'Generando preguntas del tema...', French: 'Génération de questions...', German: 'Erstelle fachspezifische Fragen...', Hindi: 'विषय-विशिष्ट प्रश्न उत्पन्न कर रहा है...', Chinese: '生成特定学科的问题...', Nepali: 'विषय-विशिष्ट प्रश्नहरू उत्पन्न गर्दै...' },
    ...
    personalize_lesson: { English: 'Personalize Lesson with AI', Spanish: 'Personalizar lección con IA', French: 'Personnaliser avec l\'IA', German: 'Lektion mit KI personalisieren', Hindi: 'AI के साथ पाठ को निजीकृत करें', Chinese: '使用 AI 个性化课程', Nepali: 'AI सँग पाठ निजीकृत गर्नुहोस्' },
    feedback_placeholder: { English: 'How should I adjust this lesson? (e.g., "Make it simpler", "Add code examples")', Spanish: '¿Cómo debo ajustar esta lección?', French: 'Comment ajuster cette leçon ?', German: 'Wie soll ich diese Lektion anpassen?', Hindi: 'मुझे इस पाठ को कैसे समायोजित करना चाहिए?', Chinese: '我应该如何调整这门课？', Nepali: 'मैले यो पाठलाई कसरी परिमार्जन गर्नुपर्छ?' },
    personalizing: { English: 'Personalizing...', Spanish: 'Personalizando...', French: 'Personnalisation...', German: 'Personalisierung...', Hindi: 'निजीकृत कर रहा है...', Chinese: '正在个性化...', Nepali: 'निजीकृत गर्दै...' }
};
